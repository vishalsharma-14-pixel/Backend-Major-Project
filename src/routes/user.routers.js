...
import { changeCurrentUserPassword, getCurrentUser, getUserChannelProfile, getWatchHistory, loggedOutUser, loginUser, registerUser, updateAccountDetails, updateUserCoverImage } from '../controller/user.controller.js';
...
router.route("/current_user").get(verifyJW, getCurrentUser)
...
router.route("/watch-history").get(verifyJW, getWatchHistory)
